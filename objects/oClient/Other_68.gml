...
//summary
//get id
//if id is client running code
//	if network state is play
//		read entire buffer to local variable
//		get number of sprites sent
//		read objects location
//		clear the render sprites list
//		for each sprite
//			add to the list the x, y, sprite_index, image_index, image_blend, player name