...
//if there is more than 0 clients
//	seek start of buffer
//	write number of clients to buffer
//	with player objects
//		send x, y, sprite_index, image_index, image_blend, player name
//	repeat previous 2 lines with baddies
//	for each client
//		get socket id
//		seek start of buffer
//		get players inastance and write x and y to buffer
