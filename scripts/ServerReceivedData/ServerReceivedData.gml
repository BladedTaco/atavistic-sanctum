...
//summary
//get the buffer to read
//read the command identifier
//read the client socket id
//look up client details
//if command identifier is for a keypress/release
//	read the key that was sent
//	read the sent keys state
//	translate key into a number value
//	translate press/release into a boolean value
//	store key and its state in player instance array
//if command identifier is for a name
//	set the client name
//if command identifier is a ping
//	ignore it