...
//create a control and stats file for the player
var _file = file_text_open_write("names/stats/" + argument[0] + ".txt")
repeat(8) { //fill the file with base values
	file_text_write_real(_file, 0); file_text_writeln(_file);
}
file_text_close(_file) //close the file

_file = file_text_open_write("names/controls/" + argument[0] + ".txt")
//write values
var _str;
